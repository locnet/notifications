...
! function(a) {
    ...
    a.fn.AnyTime_picker = function(a) { return this.each(function() { AnyTime.picker(this.id, a) }) }, a.fn.AnyTime_noPicker = function() { return this.each(function() { AnyTime.noPicker(this.id) }) }, a.fn.AnyTime_setCurrent = function(a) { return this.each(function() { AnyTime.setCurrent(this.id, a) }) }, a.fn.AnyTime_setEarliest = function(a) { return this.each(function() { AnyTime.setEarliest(this.id, a) }) }, a.fn.AnyTime_setLatest = function(a) { return this.each(function() { AnyTime.setLatest(this.id, a) }) }, a.fn.AnyTime_current = function(a, b) { a ? (this.removeClass("AnyTime-out-btn ui-state-default ui-state-disabled ui-state-active"), this.addClass("AnyTime-cur-btn ui-state-default ui-state-active")) : (this.removeClass("AnyTime-cur-btn ui-state-active"), b ? this.removeClass("AnyTime-out-btn ui-state-disabled") : this.addClass("AnyTime-out-btn ui-state-disabled")) }, a.fn.AnyTime_clickCurrent = function() { this.find(".AnyTime-cur-btn").triggerHandler("click") }, a(document).ready(function() {
        ...
        var c = 0,
            ...
            m = -1,
            n = !1;
        this.fmt = "%Y-%m-%d %T", this.dAbbr = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"], this.dNames = ["Sunday", "Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday"], this.eAbbr = ["BCE", "CE"], this.mAbbr = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"], this.mNames = ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"], this.baseYear = null, this.dAt = function(a, b) { return a.charCodeAt(b) >= "0".charCodeAt(0) && a.charCodeAt(b) <= "9".charCodeAt(0) }, this.format = function(a) {
                    ...
                    if ("%" != this.fmt.charAt(f)) e += this.fmt.charAt(f);
                        ...
                        switch (g) {
                            ...
                            case "#":
                                ...
                                break;
                            case "@":
                                if (d = h != Number.MIN_VALUE ? h : j == Number.MIN_VALUE ? 0 - b.getTimezoneOffset() : j, AnyTime.utcLabel && AnyTime.utcLabel[d]) { e += k > 0 && k < AnyTime.utcLabel[d].length ? AnyTime.utcLabel[d][k] : AnyTime.utcLabel[d][0]; break }
                                e += "UTC", g = ":";
                            case "+":
                            case "-":
                            case ":":
                ...
                return e
            }, this.getUtcParseOffsetCaptured = function() { return i }, this.getUtcParseOffsetSubIndex = function() { return m }, this.parse = function(a) {
                i = l, m = -1;
                    ...
                    if ("%" == this.fmt.charAt(v)) {
                        ...
                        switch (w) {
                            case "a":
                                for (h = !1, k = 0; r > s + k; k++) {
                                    for (j = a.substr(s, k), b = 0; 12 > b; b++)
                                        if (this.dAbbr[b] == j) { h = !0, s += k; break }
                                    if (h) break
                                }
                            ...
                            case "b":
                                for (h = !1, k = 0; r > s + k; k++) {
                                    for (j = a.substr(s, k), b = 0; 12 > b; b++)
                                        if (this.mAbbr[b] == j) { q.setMonth(b), h = !0, s += k; break }
                                    if (h) break
                                }
                            ...
                            case "M":
                                for (h = !1, k = g; r >= s + k && !(k > e); k++) {
                                    for (j = a.substr(s, k), b = 0; 12 > b; b++)
                                        if (this.mNames[b] == j) { q.setMonth(b), h = !0, s += k; break }
                                    if (h) break
                                }
                                break;
                            case "m":
                            ...
                            case "W":
                                for (h = !1, k = f; r >= s + k && !(k > d); k++) {
                                    for (j = a.substr(s, k), b = 0; 7 > b; b++)
                                        if (this.dNames[b] == j) { h = !0, s += k; break }
                                    if (h) break
                                }
                                break;
                            case "w":
                                    ...
                                    for (u in AnyTime.utcLabel)
                                        if (!Array.prototype[u]) {
                                            for (b = 0; b < AnyTime.utcLabel[u].length; b++)
                                                if (j = AnyTime.utcLabel[u][b], k = j.length, r >= s + k && a.substr(s, k) == j) { s += k, h = !0; break }
                                            if (h) break
                                        }
                                    if (h) { m = b, u = Number(u); break }
                                }
            ...
            }, this.setUtcFormatOffsetAlleged = function(a) { var b = h; return h = a, b }, this.setUtcFormatOffsetSubIndex = function(a) { var b = k; return k = a, b },
            function(h) {
                var i, k;
    ...
    }, AnyTime.noPicker = function(a) { d[a] && (d[a].cleanup(), delete d[a]) }, AnyTime.picker = function(e, f) {
        ...
        d[e] = {
            ...
            initialize: function(d) {
                ...
                if (f.ajaxOptions && (this.ajaxOpts = jQuery.extend({}, f.ajaxOptions), this.ajaxOpts.success || (this.ajaxOpts.success = function(a) { g.updVal(a) })), f.earliest && (this.earliest = this.makeDate(f.earliest)), f.firstDOW) {
                ...
                var u = null;
                if (this.pop && (u = a('<div class="AnyTime-x-btn ui-state-default">' + this.lX + "</div>"), this.hTitle.append(u), u.click(function(a) { g.dismiss(a) })), i = "", o) {
                ...
                try { this.time = this.conv.parse(this.inp.val()), this.offMin = this.conv.getUtcParseOffsetCaptured(), this.offSI = this.conv.getUtcParseOffsetSubIndex(), "init" in f && (this.time = this.makeDate(f.init)) } catch (D) { this.time = new Date }
                this.lastAjax = this.time, this.pop && (this.div.hide(), this.div.css("position", "absolute")), this.inp.blur(this.hBlur = function(a) { g.inpBlur(a) }), this.inp.click(this.hClick = function(a) { g.showPkr(a) }), this.inp.focus(this.hFocus = function(a) { g.lostFocus && g.showPkr(a), g.lostFocus = !1 }), this.inp.keydown(this.hKeydown = function(a) { g.key(a) }), this.div.click(function() { g.lostFocus = !1, g.inp.focus() }), a(window).resize(this.hResize = function(a) { g.pos(a) }), c && this.onReady()
            },
            ajax: function() {
            ...
            askOffset: function(b) {
                if (this.oDiv) this.cloak.show(), this.oDiv.show();
                    ...
                    c.append(d), d.click(function(a) { g.dismissODiv(a) }), c.append(this.lO);
                    ...
                    if (AnyTime.utcLabel)
                        for (var i = -720; 840 >= i; i++)
                            if (AnyTime.utcLabel[i]) { this.oConv.setUtcFormatOffsetAlleged(i); for (var j = 0; j < AnyTime.utcLabel[i].length && (this.oConv.setUtcFormatOffsetSubIndex(j), f = this.btn(e, this.oConv.format(this.time), this.newOPos, ["off-off"], i), f[0].AnyTime_offMin = i, f[0].AnyTime_offSI = j, h); j++); }
            ...
            askYear: function(b) {
                if (this.yDiv) this.cloak.show(), this.yDiv.show();
                    ...
                    this.yDiv.append(c);
                    var d = a('<div class="AnyTime-x-btn ui-state-default">' + this.lX + "</div>");
                    c.append(d), d.click(function(a) { g.dismissYDiv(a) }), c.append(this.lY);
            ...
            inpBlur: function(a) { return this.oDiv && this.oDiv.is(":visible") ? (g.inp.focus(), void 0) : (this.lostFocus = !0, setTimeout(function() { g.lostFocus && (g.div.find(".AnyTime-focus-btn").removeClass("AnyTime-focus-btn ui-state-focus"), g.pop ? g.dismiss(a) : g.ajax()) }, 334), void 0) },
            btn: function(b, c, d, e, f) {
                ...
                return b.append(k), k.AnyTime_title = f, k.click(function(a) { g.tempFunc = d, g.tempFunc(a) }), k.dblclick(function(b) {
                    var c = a(this);
            ...
            cleanup: function() { this.inp.prop("readonly", this.ro).off("blur", this.hBlur).off("click", this.hClick).off("focus", this.hFocus).off("keydown", this.hKeydown), a(window).off("resize", this.hResize), this.div.remove() },
            dismiss: function() { this.ajax(), this.yDiv && this.dismissYDiv(), this.oDiv && this.dismissODiv(), this.div.hide(), this.lostFocus = !0 },
            dismissODiv: function() { this.oDiv.hide(), this.cloak.hide(), this.setFocus(this.oCur) },
            dismissYDiv: function() { this.yDiv.hide(), this.cloak.hide(), this.setFocus(this.yCur) },
            setFocus: function(a) {
            ...
            key: function(a) {
                ...
                if (this.denyTab = !0, 16 == f);
                    ...
                    else if (this.fBtn.parents(".AnyTime-yrs").length) { if (9 == f) return this.denyTab = !1, void 0 } else if (this.fBtn.hasClass("AnyTime-mon-btn")) {
                    ...
                    if ((86 == f || 118 == f) && a.ctrlKey) return this.updVal(""), setTimeout(function() { e.showPkr(null) }, 100), void 0;
                    this.showPkr(null)
                }
                a.preventDefault()
            },
            ...
            keyDateChange: function(a) { this.fBtn.hasClass("AnyTime-dom-btn") && (this.set(a), this.upd(null), this.setFocus(this.dDoM.find(".AnyTime-cur-btn"))) },
            makeCloak: function() { this.cloak ? this.cloak.show() : (this.cloak = a('<div class="AnyTime-cloak"></div>'), this.div.append(this.cloak), this.cloak.click(function(a) { g.oDiv && g.oDiv.is(":visible") ? g.dismissODiv(a) : g.dismissYDiv(a) })) },
            makeDate: function(a) { if ("number" == typeof a ? a = new Date(a) : "string" == typeof a && (a = this.conv.parse(a)), "getTime" in a) return a; throw new Exception("cannot make a Date from " + a) },
            newHour: function(b) {
            ...
            newOffset: function(a) { a.target == this.oSel[0] ? this.askOffset(a) : this.upd(this.oCur) },
            newOPos: function(b) {
                var c = a(b.target);
            ...
            onReady: function() { this.lostFocus = !0, this.pop ? this.div.parent() != document.body && this.div.appendTo(document.body) : this.upd(null) },
            pos: function() {
                if (this.pop) {
                    ...
                    0 > f && (f = b.top + this.inp.outerHeight(!0)), this.div.css({ top: String(f) + "px", left: String(0 > e ? 0 : e) + "px" })
                }
                ...
                } else if (this.yDiv && this.yDiv.is(":visible")) { var m = this.yLab.offset(); "absolute" == this.div.css("position") && (m.top -= g.top, m.left = m.left - g.left, g = { top: 0, left: 0 }), m.left += (this.yLab.outerWidth(!0) - this.yDiv.outerWidth(!0)) / 2, this.yDiv.css({ top: m.top + "px", left: m.left + "px" }) }
            ...
            setCurrent: function(a) { this.set(this.makeDate(a)), this.upd(null) },
            setEarliest: function(a) { this.earliest = this.makeDate(a), this.set(this.time), this.upd(null) },
            setLatest: function(a) { this.latest = this.makeDate(a), this.set(this.time), this.upd(null) },
            showPkr: function(a) {
                try { this.time = this.conv.parse(this.inp.val()), this.offMin = this.conv.getUtcParseOffsetCaptured(), this.offSI = this.conv.getUtcParseOffsetSubIndex() } catch (b) { this.time = new Date }
